            ...
            for (var _iterator7 = this.iterate(this.constructor.prototype)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
                ...
                if (key.match("::")) {
                    ...
                    (function () {
                        ...
                        el = _this2.$element ? _this2.$element.context : zest("[ng-app]", document.body)[0];
                        _iteratorNormalCompletion8 = true;
                        _didIteratorError8 = false;
                        _iteratorError8 = undefined;

                        try {
                            for (_iterator8 = (tokens[0] ? zest(tokens[0], el).entries() : [el].entries())[Symbol.iterator](); !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
    ...
    function Component() {
        ...
        try {
            for (var _iterator22 = this.transform.entries()[Symbol.iterator](), _step22; !(_iteratorNormalCompletion22 = (_step22 = _iterator22.next()).done); _iteratorNormalCompletion22 = true) {
                ...
                var _Service = this["" + dataset.descriptor[0].toUpperCase() + "" + dataset.descriptor.substr(1) + "DataService"];
